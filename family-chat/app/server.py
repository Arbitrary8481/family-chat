...
# theoretical: multiple real, documented cases exist of other add-ons losing
...
def admin_import():
    ...
    try:
        ...
        logger.warning('Data restored from an uploaded backup by an admin — restart the add-on to ensure every connection picks up the new data cleanly.')
